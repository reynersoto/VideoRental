...
namespace WebMvcPruebaMosh.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = CreateUser();
                //Add here custom params 
                user.InternalCode = Input.InternalCode;
                //
                ...
                if (result.Succeeded)
                {
                    ...
                    ////TEMP CODE FOR ROLES
                    //var roleStore = new RoleStore<IdentityRole>(new ApplicationDbContext(null));
